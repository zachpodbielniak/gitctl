...
/* gitctl-cmd-release.h - Release command handler */

#ifndef GCTL_CMD_RELEASE_H
#define GCTL_CMD_RELEASE_H
 ...
 *
 * Main entry point for the "release" command.  Dispatches to the
 * appropriate verb handler: list, get, create, or delete.
 *
