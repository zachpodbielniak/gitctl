...
/* gitctl-cmd-key.h - SSH/deploy key command handler */

#ifndef GCTL_CMD_KEY_H
#define GCTL_CMD_KEY_H
 ...
 *
 * Main entry point for the "key" command.  Dispatches to the
 * appropriate verb handler: list, add, or remove.
 *
